...
module.exports = {
    ...
    create: function(req, res, next){ 
        if(req.body.password != req.body.confirm_password){
            res.render('users/create', {errors: {confirm_password: {message: 'The password and the confirm password does not macth'}}, user: new User({name: req.body.name, email: req.body.email})});
            return;
        }
